...
class TrainParams(BasicParams):
    ...
    def initialize(self, parser):
        ...
        # Training parameters
        parser.add_argument('--epoch-num-p1', type=int, default=50,
                            help='epoch number for phase 1')
        parser.add_argument('--epoch-num-p2', type=int, default=50,
                            help='epoch number for phase 2')
        parser.add_argument('--epoch-num-p3', type=int, default=100,
                            help='epoch number for phase 3')
        parser.add_argument('--lr', type=float, default=1e-4,
                            help='initial learning rate')
        parser.add_argument('--beta1', type=float, default=0.5,
                            help='momentum term of adam')
        parser.add_argument('--lr-policy', type=str, default='linear',
        ...
        parser.add_argument('--epoch-num-decay', type=int, default=50,
                            help='Number of epoch to linearly decay learning rate to zero (lr_policy == linear)')
        parser.add_argument('--decay-step-size', type=int, default=50,
